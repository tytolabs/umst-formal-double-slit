...
lean_lib ChemConstants where
  roots := #[`ChemConstants.ExactSiInteger, `ChemConstants.NamedOccupancyExceptions,
    ...
    -- CHEM-FORMAL-Q-LEAN-CHEMCONSTANTS-LAKEFILE-ROOTS: remainder COMPLETE modules wired as Lake roots.
    `ChemConstants.CatalysisConservation,
    `ChemConstants.PhaseEutecticSolidSolutionConservation,
    `ChemConstants.SurfaceVsBulkSdfConservation,
    `ChemConstants.AqueousVsMineralConservation,
    `ChemConstants.RedoxLadderConservation,
    `ChemConstants.PolymorphismConservation,
    `ChemConstants.TpParametricConservation,
    `ChemConstants.ContaminationReverseRefineConservation,
    `ChemConstants.AssayMeasurementLandauerConservation,
    `ChemConstants.VacuumInertLimitConservation,
    `ChemConstants.ContinuumVsDiscreteElementIdConservation,
    `ChemConstants.OtherNamedNuanceConservation,
    `ChemConstants.CrExceptionContinuum,
    `ChemConstants.CuExceptionContinuum,
    `ChemConstants.NbExceptionContinuum,
    `ChemConstants.MoExceptionContinuum,
    `ChemConstants.RuExceptionContinuum,
    `ChemConstants.RhExceptionContinuum,
    `ChemConstants.PdExceptionContinuum,
    `ChemConstants.AgExceptionContinuum,
    `ChemConstants.LaExceptionContinuum,
    `ChemConstants.CeExceptionContinuum,
    `ChemConstants.GdExceptionContinuum,
    `ChemConstants.PtExceptionContinuum,
    `ChemConstants.AuExceptionContinuum,
    `ChemConstants.AcExceptionContinuum,
    `ChemConstants.ThExceptionContinuum,
    `ChemConstants.PaExceptionContinuum,
    `ChemConstants.UExceptionContinuum,
    `ChemConstants.NpExceptionContinuum,
    `ChemConstants.CmExceptionContinuum,
    `ChemConstants.LrExceptionContinuum,
    `ChemConstants.LiveGTpxConservation,
    `ChemConstants.LiveDensityRhoConservation,
    `ChemConstants.LiveScaleCommuteConservation,
    `ChemConstants.LiveEco02ConsumeConservation,
    `ChemConstants.LivePatternBundleConservation,
    `ChemConstants.LiveRemainderRowConservation,
    `ChemConstants.ConstitutiveGEngineConservation,
    `ChemConstants.HomeostasisGminConservation,
    `ChemConstants.PurifyRefineLiveConservation,
    `ChemConstants.IsotopeNuclearBoundaryConservation,
    `ChemConstants.NaturalVsPurifiedEnvConservation,
    `ChemConstants.OgRelativisticConservation,
