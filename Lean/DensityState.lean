...
/-- PSD implies Hermitian; bundled as dot-notation for spectral API (`ρ.isHermitian.eigenvalues`). -/
abbrev DensityMatCore.isHermitian (ρ : DensityMatCore hn) : ρ.carrier.IsHermitian :=
  ρ.psd.isHermitian
