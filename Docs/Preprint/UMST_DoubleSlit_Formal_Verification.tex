...
\textit{Machine-checked in Lean\,4 with Mathlib.\; \textbf{529 theorems, 0 \texttt{sorry}, 3 explicit axioms} (physical second law, visibility bound, dephasing limit); Klein spectral relative entropy $\geq 0$ is proved, not axiomatized.}
\end{leftbox}
...
\midrule
Formal proof & Lean 4 + Mathlib & 53 mod., 529 thm., 54 lem. & \textbf{0 sorry}, \textbf{3 axioms} \\
...
%--- Our work ---
\bibitem{umst-formal} S.~Shyamsundar and S.\,P.~Shenbagamoorthy, ``Formal Verification and Categorical Semantics for the UMST/DUMSTO Thermodynamic Gate,'' \texttt{umst-formal} (double-slit extension track), GitHub, 2026. Lean\,4: 529 \texttt{theorem}s, 53 \texttt{lakefile} roots, 65 scanned \texttt{.lean} files; 0 \texttt{sorry}; 3 \texttt{axiom}s (see \texttt{PROOF-STATUS.md}).
