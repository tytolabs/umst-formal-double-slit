...
\item Full unital quantum DPI / Klein inequality on compound systems: axiomatized in \texttt{DataProcessingInequality.lean}; Klein becomes a theorem when Mathlib matrix-log infrastructure is available. Quantum mutual information $I(A\!:\!B) = S(A){+}S(B){-}S(AB)$ is now formally proved in \texttt{QuantumMutualInfo.lean}.
...
\midrule
Formal proof & Lean 4 + Mathlib & 53 modules, 515 theorems & \textbf{0 sorry}, \textbf{6 axioms} \\
...
Cross-language & Coq + Agda & 9 Coq + 11 Agda modules & Coq: \textbf{2 Admitted}; Agda: \textbf{clean} \\
\bottomrule
\end{tabular}}
